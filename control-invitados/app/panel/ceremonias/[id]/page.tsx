            ...
            <div className="flex items-center gap-3 self-start">
              ...
              {(ceremonia?.estado === "planificada" || ceremonia?.estado === "en_curso") && (
                <button
                  ...
                  className="flex items-center gap-2 px-4 py-2.5 text-xs font-bold text-white bg-red-600 hover:bg-red-700 rounded-lg transition-all shadow-sm"
                >
                  Finalizar Ceremonia
                </button>
              )}
              ...
              {autoridades.map((a: { cargo: string; nombre: string }, i: number) => (
                ...
                >
                  ...
                  <button
                    ...
                    className="p-2.5 rounded-lg text-gray-400 hover:text-error hover:bg-error-container dark:hover:bg-red-900/50 transition-colors"
                  >
                    <Trash2 size={16} />
                  </button>
                </div>
                    ...
                    >
                      ...
                      <td className="px-4 py-3 text-center">
                        <button
                          ...
                          className="p-2.5 rounded-lg text-gray-400 hover:text-primary hover:bg-primary-fixed dark:hover:bg-primary/30 transition-all"
